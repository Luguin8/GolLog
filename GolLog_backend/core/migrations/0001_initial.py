    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liga', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equipos_de_liga', to='core.liga')),
            ],
        ),
        migrations.CreateModel(
            name='Partido',
            fields=[
                ...
                ('status_partido', models.CharField(default='Programado', max_length=50)),
